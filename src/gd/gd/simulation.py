...
from gd.gd.grasp import Label
from gd.gd.perception import *
from gd.gd.utils import btsim, workspace_lines
from gd.gd.utils.transform import Rotation, Transform
...
class ClutterRemovalSim(object):
    ...
    def acquire_tsdf(self, n, N=None):
        ...
        extrinsics  = [camera_on_sphere(origin, r, theta, phi)[0].as_matrix() for phi in phi_list]        
        look_at = [camera_on_sphere(origin, r, theta, phi)[1] for phi in phi_list]
        ...
        return tsdf, high_res_tsdf.get_cloud(), timing, extrinsics , look_at
